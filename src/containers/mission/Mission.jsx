...
const About = () => (
  <div className="step0__mission section__margin">
    {/* <div className="step0__mission-heading">
      <h1 className="gradient__text"></h1>
    </div> */}
    <div className="step0__mission-container">
